...
```bash
wget -O /root/naive.sh https://raw.githubusercontent.com/wzj939/naiveproxy-script/main/naive.sh && chmod +x /root/.naive.sh && ln -sf /root/naive.sh /usr/local/bin/naive
